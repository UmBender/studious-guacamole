...
\begin{titlepage}
  \begin{center}
      \vspace*{-3cm}
       ...
       \fi
        Bolsista: \nomeAutor \\
        Orientador: Prof. Dr. Tiago de Carvalho
        \vfill
...
\newcommand{\Resumo}[1]{
   \begin{otherlanguage}{portuguese}
       \addcontentsline{toc}{chapter}{Resumo do Projeto Inicial}
       \renewcommand{\abstractname}{Resumo do Projeto Inicial}
...
\newcommand{\Abstract}[1]{
   \begin{otherlanguage}{english}
      ...
      \renewcommand{\abstractname}{Abstract of the Initial Submission}
